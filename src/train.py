...
class Trainer:
    def __init__(
        ...
        self.save_steps = cfg.training.save_steps
            ...
            for batch in tqdm(self.train_dataloader):
                ...
                if it % self.eval_steps == 0 and it > 0:
                    ...
                    if not self.cfg.training.dry_run:
                        ...
                        if eval_stopping_metric == 'accuracy':
                            eval_metric_value = -eval_metric_value
                        if eval_metric_value < min_eval_metric:
                            min_eval_metric =  eval_metric_value
